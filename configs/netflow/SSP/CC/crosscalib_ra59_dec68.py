...
DATA_DIR = '$PFS_TARGETING_DATA/data/targeting/CC/crosscalib_ra59_dec68'
...
config = dict(
    ...
    field = dict(
        key = "crosscalib_ra59_decm68",
        name = "Cross-Calibration ra=59 dec=68",
        obs_time = datetime(2026, 9, 15, 15, 0, 0),
        id_prefix = ID_PREFIX
    ),
    pointings = [
        dict(ra=59.29434812625, dec=68.33841263894, posang=120.0, priority=9),
    ],
    targets = {
        # Miho
        "gaia": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra59_dec68.ecsv',
        ...
        # Miho
        "sky": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra59_dec68_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        # Miho
        "fluxstd": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra59_dec68_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
            ...
            mask = 'lambda df: (df["prob_f_star"] > 0.5) | (df["is_fstar_gaia"] == True)',
            prefix = "cal",
            catid = CATID_FLUXSTD,
            extra_columns = {
                **{
