...
DATA_DIR = '$PFS_TARGETING_DATA/data/targeting/CC/crosscalib_ra335_dec50'
...
config = dict(
    ...
    field = dict(
        key = "crosscalib_ra335_dec50",
        name = "Cross-Calibration ra=335 dec=50",
        obs_time = datetime(2026, 7, 15, 15, 0, 0),
        id_prefix = ID_PREFIX
    ),
    pointings = [
        dict(ra=334.997, dec=49.971, posang=0.0, priority=9),
    ],
    targets = {
        # Miho
        "gaia": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra335_dec50.ecsv',
        ...
        # Miho
        "sky": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra335_dec50_sky.csv',
            reader_args = dict(),
            column_map = {
                'obj_id': 'targetid',
                'catalog_id': 'catid',
        ...
        # Miho
        "fluxstd": dict(
            path = f'{DATA_DIR}/ga_crosscalib_ra335_dec50_fluxstd.csv',
            reader_args = dict(),
            column_map = {
                'fluxstd_id': 'targetid',
                'obj_id': 'orig_objid',
